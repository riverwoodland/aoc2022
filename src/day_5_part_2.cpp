...
void parseCratesRow(std::vector<std::vector<char>>& crateColumns, const std::string& row)
{
...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    parseCratesRow(crateColumns, line);
    ...
    while (std::getline(fileStream, line))
    {
        ...
        dstColumn.insert(dstColumn.end(), srcColumn.end() - moveCount, srcColumn.end());
